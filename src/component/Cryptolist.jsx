      ...
      {allData && allData.map((item, index)=>{
        return(
          <div key={index} className='pl-[24.8px] flex items-center mt-5 relative h-10 cursor-pointer'>
            ...
            <div>
                <img src={Up} alt="" className='absolute left-[640px] top-3 2xl:left-[800px]'/>
              <span className=' absolute left-[665px] top-2 2xl:left-[830px] font-normal text-[18.8799px] text-[#32D583] flex gap-[12.98px]'>
                {item.change}%
              </span>
            </div>
            <div>
              <span className='absolute right-[275px] top-2 2xl:right-[320px] font-normal text-[18.8799px] text-[#101828]'>
                {item.listedAt}
              </span>
            </div>
            </div>
